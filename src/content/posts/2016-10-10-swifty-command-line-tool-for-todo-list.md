...
As I mention in [README](https://github.com/pixyzehn/stodo/blob/master/README.md), you can use `stodo` like this.
...
<img src="/assets/posts/example-stodo.png" alt="stodo" height="100">

If you wanna make command line tool, these links and repos might be good ref.  

- [realm/SwiftCov](https://github.com/realm/SwiftCov)  
- [Carthage/Carthage](https://github.com/Carthage/Carthage)  
- [gigitnet/Toybox](https://github.com/giginet/Toybox)  
- [kitasuke/GithubCLI](https://github.com/kitasuke/GithubCLI.swift)  
- [JPMartha/Pancake](https://github.com/JPMartha/Pancake)  
- [erica/tmdiff](https://github.com/erica/tmdiff)  
- [Command Line Tool In Swift](http://www.slideshare.net/kitasuke/command-line-tool-in-swift)  
