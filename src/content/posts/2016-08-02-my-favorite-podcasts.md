...
Their topics are not only about iOS development but also about functional programming, Vim, [Elm](http://elm-lang.org/) and so on. I really like their personality and the atmosphere in their conversation. Their episodes are less than 30 ~ 40 minutes, so these are very listenable for me.
...
Actually, I'm a big fan of [Marco Arment](https://marco.org/). They're not talking about new things like a Swift's new feature now, but they have great knowledge of iOS app development and iOS market. I always use [Overcast](https://overcast.fm/) that Marco created.
...
\- [Release Notes](https://releasenotes.tv/aboutthepodcast/)
...
\- [Swift Playhouse](http://swiftplayhouse.libsyn.com/)
